...
FEEDBACK={"Domestic Violence":"Keine problematische Sprache gefunden!",
          ...
          "Sensationalistisch":"**Sensationalistische Sprache** kann durch den Fokus auf spektakuläre Aspekte von den eigentlichen Ursachen und der Problematik von häuslicher Gewalt ablenken. Überlege dir, ob die Formulierung angemessen ist, oder zu Übertreibung, blumiger oder dramatischer Sprache neigt.",
