...
def load_meth():
    ...
    st.image("media/Projektvorgehen.png","Projektvorgehen")
    ...
    with left:
        st.image("media/bert_structure.png", width=300, caption="Structure of Transformer, taken from 'Attention Is All You Need' (https://arxiv.org/abs/1706.03762)", output_format="PNG")
    with right:
    ...
    st.image("media/Modelstruktur.png", width=600)
    ...
    df=pd.read_csv("media/model_performances.csv", index_col=0)
    with mid:
        st.dataframe(df)
